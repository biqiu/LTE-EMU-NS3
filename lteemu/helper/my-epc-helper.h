...
#ifndef MY_EPC_HELPER_H
#define MY_EPC_HELPER_H
 ...
 * interface. 
 */
class MyEpcHelper : public Object
{
public:
...
private:
  ...
  Ptr<Node> m_sgwPgw; 
  Ptr<MyEpcSgwPgwApplication> m_sgwPgwApp;
