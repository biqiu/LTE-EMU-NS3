...
#ifndef MY_EPC_SGW_PGW_APPLICATION_H
#define MY_EPC_SGW_PGW_APPLICATION_H
 ...
 */
class MyEpcSgwPgwApplication : public Application
{
  friend class MemberEpcS11SapSgw<MyEpcSgwPgwApplication>;
...
public:
   ...
   */
  MyEpcSgwPgwApplication (const Ptr<VirtualNetDevice> tunDevice, const Ptr<Socket> s1uSocket);

  /** 
   * Destructor
   */
  virtual ~MyEpcSgwPgwApplication (void);
...
#endif /* MY_EPC_SGW_PGW_APPLICATION_H */
