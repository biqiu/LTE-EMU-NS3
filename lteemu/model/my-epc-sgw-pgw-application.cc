...
#include "my-epc-sgw-pgw-application.h"
#include "ns3/log.h"
...
NS_LOG_COMPONENT_DEFINE ("MyEpcSgwPgwApplication");
...
MyEpcSgwPgwApplication::UeInfo::UeInfo ()
{
  NS_LOG_FUNCTION (this);
}

void
MyEpcSgwPgwApplication::UeInfo::AddBearer (Ptr<EpcTft> tft, uint8_t bearerId, uint32_t teid)
{
...
uint32_t
MyEpcSgwPgwApplication::UeInfo::Classify (Ptr<Packet> p)
{
...
Ipv4Address 
MyEpcSgwPgwApplication::UeInfo::GetEnbAddr ()
{
  return m_enbAddr;
}

void
MyEpcSgwPgwApplication::UeInfo::SetEnbAddr (Ipv4Address enbAddr)
{
  m_enbAddr = enbAddr;
}

Ipv4Address 
MyEpcSgwPgwApplication::UeInfo::GetUeAddr ()
{
  return m_ueAddr;
}

void
MyEpcSgwPgwApplication::UeInfo::SetUeAddr (Ipv4Address ueAddr)
{
  m_ueAddr = ueAddr;
}

/////////////////////////
// MyEpcSgwPgwApplication
/////////////////////////


TypeId
MyEpcSgwPgwApplication::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::MyEpcSgwPgwApplication")
    .SetParent<Object> ();
  return tid;
}

void
MyEpcSgwPgwApplication::DoDispose ()
{
  NS_LOG_FUNCTION (this);
...
MyEpcSgwPgwApplication::MyEpcSgwPgwApplication (const Ptr<VirtualNetDevice> tunDevice, const Ptr<Socket> s1uSocket)
    ...
    m_s11SapMme (0)
{
  ...
  m_s1uSocket->SetRecvCallback (MakeCallback (&MyEpcSgwPgwApplication::RecvFromS1uSocket, this));
  m_s11SapSgw = new MemberEpcS11SapSgw<MyEpcSgwPgwApplication> (this);
}

  
MyEpcSgwPgwApplication::~MyEpcSgwPgwApplication ()
{
  NS_LOG_FUNCTION (this);
}
...
bool
MyEpcSgwPgwApplication::RecvFromTunDevice (Ptr<Packet> packet, const Address& source, const Address& dest, uint16_t protocolNumber)
{
...
void 
MyEpcSgwPgwApplication::RecvFromS1uSocket (Ptr<Socket> socket)
{
...
void 
MyEpcSgwPgwApplication::SendToTunDevice (Ptr<Packet> packet, uint32_t teid)
{
...
void 
MyEpcSgwPgwApplication::SendToS1uSocket (Ptr<Packet> packet, Ipv4Address enbAddr, uint32_t teid)
{
...
void 
MyEpcSgwPgwApplication::SetS11SapMme (EpcS11SapMme * s)
{
  m_s11SapMme = s;
}

EpcS11SapSgw* 
MyEpcSgwPgwApplication::GetS11SapSgw ()
{
  return m_s11SapSgw;
}

void 
MyEpcSgwPgwApplication::AddEnb (uint16_t cellId, Ipv4Address enbAddr, Ipv4Address sgwAddr)
{
...
void 
MyEpcSgwPgwApplication::AddUe (uint64_t imsi)
{
...
void 
MyEpcSgwPgwApplication::SetUeAddress (uint64_t imsi, Ipv4Address ueAddr)
{
...
void 
MyEpcSgwPgwApplication::DoCreateSessionRequest (EpcS11SapSgw::CreateSessionRequestMessage req)
{
...
void 
MyEpcSgwPgwApplication::DoModifyBearerRequest (EpcS11SapSgw::ModifyBearerRequestMessage req)
{
